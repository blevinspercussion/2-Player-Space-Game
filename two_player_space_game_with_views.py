...
class TitleView(arcade.View):
    ...
    def  on_show(self):
        ...
        self.texture = arcade.load_texture("C:\\Users\\Adam Blevins\\Desktop\\2 Player Space Game\\space_shooter_title.png")
...
class GameOverView(arcade.View):
    ...
    def on_draw(self):
        """ Draw this view. """
        arcade.start_render()
        arcade.draw_text(f"GAME OVER\n{self.winner} WINS!\n(Press 'Enter' to play again)", SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2, arcade.color.WHITE, font_size=35, anchor_x="center")
